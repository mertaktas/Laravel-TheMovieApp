...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="/img/portrait.png" alt="" class="w-64 md:w-96">
            <div class="md:ml-24">
                ...
                <div class="flex items-center flex-wrap text-gray-400 text-sm">
                    ...
                    <span class="mx-2">|</span>
                    <span>Actions, Thrilled, Drame</span>
                </div>

                <p class="text-gray-300-mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique ad in cupiditate vel architecto. Voluptates ex minima perspiciatis voluptatibus distinctio commodi nulla nihil natus? Animi, et? Optio tempore nisi ipsum.</p>
    ...
    <div class="movie-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="mt-8">
                    <a href="#">
                        <img src="/img/portrait.png" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
