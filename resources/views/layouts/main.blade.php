        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex  items-center">
                <div class="relative mt-3 md:mt-0">
                    <input type="text" class="bg-gray-800 text-small rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus-shadow-none" placeholder="Search">
                    ...
                    <div class="md:ml-4 ml-2 mt-3 md:mt-0">
                        <a href="#">
                            <img src="/img/portrait.png" class="rounded-full w-8 h-8" alt="portrait">
                        </a>
                    </div>
            </div>
        </div>
